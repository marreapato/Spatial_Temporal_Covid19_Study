...
## Introdução {.tabset .tabset-fade .tabset-pills}
 ...
 The main goal of this paper is to present methods used to identify spatial and spatio-temporal dependence by using the Global Moran's I and the Local Moran's I $\!\!^4$, which is also known as a LISA statistic (Local Indicator of Spatial Association), both being used as indicators of spatial association. Spatio-temporal association was evaluated by computing a spatio-temporal poisson scan statistic proposed by Kulldorff (place reference here) to identify emerging or "alive" *clusters* in space and time.
