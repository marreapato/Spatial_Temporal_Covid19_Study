...
#### Moran's I
 ...
 To evaluate the spatial association during the pandemic, the knn method was used to create spatial polygons and to build the spatial weight matrices, necessary to calculate the Global Moran's I and the *LISA*. The Global Moran's I is widely used and gathers all spatial dependence in one value $\!\!^6$, while the Local Moran's I useful to identify patterns of spatial association, is of great value 
