...
#### The Scan Poisson statistc
 ...
 The use of a spatio-temporal scan statistic is useful to identify emerging *clusters*, since the purely spatial scan statistic has a few limitations as it's pointed by Kulldorff (2001, p. 66), by conducting a purely spatial analysis for a long period of time
 
  (2001, p. 66) se fizermos uma análise puramente especial por um período extensivo de tempo, nós temos pouco poder para detectar *clusters* emergentes, a solução portanto seria usar uma estatística de scan espaço-temporal.
