...
#### Moran's I
 ...
 To evaluate the spatial association during the pandemic, the knn method was used to create spatial polygons and to build the row standardized neighborhood matrix, necessary to calculate the Global Moran's I and the *LISA*.
 
  O índice global é o método tradicionalmente usado e condensa a dependência espacial em apenas um número $\!\!^6$, no entanto o uso do indicador local de associação espacial (*LISA*) utilizado para identificar padrões espaciais, se faz útil pois de acordo com Maia, Gomes e Almeida (2018, p.930) enquanto o índice de Moran global pode sugerir que haja baixa correlação espacial nos dados, os valores do *LISA* podem identificar sub-regiões geográficas em que o agrupamento (*clustering*) negativo ou positivo ocorram $\!\!^7$.
