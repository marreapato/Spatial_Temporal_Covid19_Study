...
**Equation 2**
 ...
 Where $s^{2}_{i}$ is the variance of the studied variable $x_{i}$:
  ...
  The maps for the Local Moran's I, *Boxmaps* and Global Moran's I tables, were built for variables (number of cases and deaths) which achieved a global index IM>0.50.
