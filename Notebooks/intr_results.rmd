...
#### A estatística de Scan Poisson
 ...
 O uso da estatística de scan espaço temporal é indicado, pois para identificar *clusters* emergentes a estatística puramente espacial pode apresentar limitações, como evidenciado em Kulldorff (2001, p. 66, tradução nossa) " Se fizermos uma análise puramente especial por um período extensivo de tempo, nós temos pouco poder para detectar *clusters* emergentes. [...] Uma solução, portanto seria usar uma estatística de scan espaço-temporal".
