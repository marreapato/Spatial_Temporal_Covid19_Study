...
## Metodologia
 ...
 Também foi utilizado um segundo banco de dados disponibilizado pela *Our World In Data* $\!\!^9$ (*OWID*), o banco provido pela *OWID* contém informações que foram utilizadas como complementares ao da *COVID-19 Data Hub*, como o número diário de casos confirmados e mortes por Covid-19. As informações sobre o número diário foram utilizadas para calcular a média móvel semanal para a variável de estudo. Além de calcular a média móvel do número de casos e mortos pela Covid-19 por dia no mundo, a estatística também foi computada para os continentes em que foi identificado dependência espacial local.
...
![](media_movel.png)
**Figura 2 -** Média móvel semanal do número de novos casos da covid19.

![](n_mortes.png)
**Figura 3 -** Média móvel semanal do número de novas mortes pela covid19.
