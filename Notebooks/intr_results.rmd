...
#### A estatística de Scan Poisson
 ...
 Em busca de identificar *clusters* emergentes no espaço-tempo, o método prospectivo proposto por Kulldorff foi utilizado supondo uma distribuição de probabilidade poisson. Em contrapartida ao método puramente espacial $\!\!^1$ $\!\!^1$, em que a estatística de scan cria diversas janelas circulares em localidades no mapa, cada uma com diferentes grupos de áreas vizinhas para  
