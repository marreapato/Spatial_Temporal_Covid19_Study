...
## Resultados
 ...
 Os índices globais de Moran para o número mensal de casos por habitantes **(Tabela 2)** apresentaram uma maior dependência espacial nos meses de Outubro, Novembro e Dezembro (IM>0,50; P-valor<0,05), com dependência local identificada na Europa Central até o Leste Europeu. A estatística de scan apresentou diversas similaridades ao encontrar *clusters* emergentes que foram identificados também pelo índice de Moran local, sendo os meses de maior diferença em relação ao *LISA*: Julho, Agosto, Setembro e Dezembro.
