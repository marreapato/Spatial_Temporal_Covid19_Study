...
#### A estatística de Scan Poisson
 ...
 Em busca de identificar *clusters* emergentes no espaço-tempo, o método prospectivo proposto por Kulldorff foi utilizado supondo uma distribuição de probabilidade poisson. Neste método, apesar da razão de verossimilhança ser calculada da mesma maneira que o método puramente espacial $\!\!^1$ $\!\!^1$, 
