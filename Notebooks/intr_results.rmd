...
#### A estatística de Scan Poisson
 ...
 Em busca de identificar *clusters* emergentes no espaço-tempo, o método prospectivo proposto por Kulldorff foi utilizado supondo uma distribuição de probabilidade poisson. No método puramente espacial $\!\!^1$ $\!\!^1$, a estatística de scan cria diversas janelas circulares em diversas localidades no mapa, cada uma com diferentes grupos de áreas vizinhas, sendo cada uma dessas janelas circulares flexíveis em tamanho e localidade e possivelmente um *cluster* de eventos.  para  
