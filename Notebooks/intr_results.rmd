...
#### Índice de Moran
 ...
 O Índice global de Moran é calculado de tal maneira que temos $w$ como sendo a matriz de vizinhança, e $x$ os valores da variável de estudo e $n$ o número de polígonos identificados:
