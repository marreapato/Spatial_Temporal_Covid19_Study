...
## Conclusão
 ...
 A presença de semelhanças dentre as políticas de isolamento social, restrição de multidões, rastreamento de casos e os aumentos no número de infectados pela Covid-19, nas regiões em que foi identificada correlação espacial local, existe portanto a necessidade de se investigar se as semelhanças, ou as diferenças dentre as medidas políticas, foram determinantes para o aumento da média móvel de casos no mundo, e para a presença de dependência espacial global, e local no número de mortes por habitantes nos continentes em que foi verificada.
